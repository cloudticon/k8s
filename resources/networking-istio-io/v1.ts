...
export const gateway = resource("networking.istio.io/v1", "Gateway", {
  scope: "Namespaced",
  shortNames: ["gw"],
  spec: {
...
export const serviceEntry = resource("networking.istio.io/v1", "ServiceEntry", {
  scope: "Namespaced",
  shortNames: ["se"],
  spec: {
...
export const sidecar = resource("networking.istio.io/v1", "Sidecar", {
  scope: "Namespaced",
  spec: {
    egress: z
      .array(
