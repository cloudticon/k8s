      ...
      .object({
        ...
        spec: z
          .object({
            ...
            manualSelector: z.boolean().optional(),
                    ...
                    .object({
                      ...
                      onExitCodes: z
                        .object({
                          ...
                          operator: z.enum(["In", "NotIn"]).default(""),
                          values: z.array(z.number().default(0)),
                        })
                        .optional(),
                      onPodConditions: z.array(
                        z
                          .object({
...
export const job = /* @__PURE__ */ resource("batch/v1", "Job", {
    ...
    podFailurePolicy: z
      .object({
        rules: z.array(
          z
            .object({
              action: z.enum(["Count", "FailJob", "Ignore"]).default(""),
              onExitCodes: z
                .object({
                  containerName: z.string().optional(),
                  operator: z.enum(["In", "NotIn"]).default(""),
  ...
  status: {
    ...
    completedIndexes: z.string().optional(),
    ...
    uncountedTerminatedPods: z
      .object({
        failed: z.array(z.string().default("")).optional(),
        succeeded: z.array(z.string().default("")).optional(),
      })
      .optional(),
  },
});
