...
export interface EndpointsOpts {
  name: string;
  namespace?: string;
  labels?: Record<string, string>;
  annotations?: Record<string, string>;
...
export function endpoints(opts: EndpointsOpts): ResourceManifest {
  return resource({
    apiVersion: "core/v1",
    kind: "Endpoints",
    metadata: {
...
export interface LimitRangeOpts {
  name: string;
  namespace?: string;
  labels?: Record<string, string>;
  annotations?: Record<string, string>;
...
export function limitRange(opts: LimitRangeOpts): ResourceManifest {
  return resource({
    apiVersion: "core/v1",
    kind: "LimitRange",
    metadata: {
...
export function node(opts: NodeOpts): ClusterScopedResourceManifest {
  return resourceClusterScope({
    apiVersion: "core/v1",
    kind: "Node",
    metadata: {
...
export interface PersistentVolumeClaimOpts {
  name: string;
  namespace?: string;
  labels?: Record<string, string>;
  annotations?: Record<string, string>;
...
export function persistentVolumeClaim(
  opts: PersistentVolumeClaimOpts,
): ResourceManifest {
  return resource({
    apiVersion: "core/v1",
...
export interface PersistentVolumeOpts {
  name: string;
  labels?: Record<string, string>;
  annotations?: Record<string, string>;
...
export function pod(opts: PodOpts): ResourceManifest {
  return resource({
    apiVersion: "core/v1",
    kind: "Pod",
    metadata: {
...
export interface ReplicationControllerOpts {
  name: string;
  namespace?: string;
  labels?: Record<string, string>;
  annotations?: Record<string, string>;
...
export function replicationController(
  opts: ReplicationControllerOpts,
): ResourceManifest {
  return resource({
    apiVersion: "core/v1",
...
export interface ResourceQuotaOpts {
  name: string;
  namespace?: string;
  labels?: Record<string, string>;
  annotations?: Record<string, string>;
...
export function resourceQuota(opts: ResourceQuotaOpts): ResourceManifest {
  return resource({
    apiVersion: "core/v1",
    kind: "ResourceQuota",
    metadata: {
...
export function serviceAccount(opts: ServiceAccountOpts): ResourceManifest {
  return resource({
    apiVersion: "core/v1",
    kind: "ServiceAccount",
    metadata: {
