...
export const gateway = resource("networking.istio.io/v1beta1", "Gateway", {
  scope: "Namespaced",
  shortNames: ["gw"],
  spec: {
...
export const proxyConfig = resource(
  "networking.istio.io/v1beta1",
  "ProxyConfig",
  {
    scope: "Namespaced",
...
export const sidecar = resource("networking.istio.io/v1beta1", "Sidecar", {
  scope: "Namespaced",
  spec: {
    egress: z
      .array(
